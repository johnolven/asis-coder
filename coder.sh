...
for mod in swarm_common.sh swarm_role.sh swarm_enroll.sh swarm_daemon.sh swarm_bootstrap.sh swarm_wizard.sh device_manager.sh worktree_manager.sh project_swarm.sh swarm_manager.sh agent_comm.sh swarm_ralph.sh prd_generator.sh swarm_project_wizard.sh swarm_dashboard.sh swarm_router.sh; do
